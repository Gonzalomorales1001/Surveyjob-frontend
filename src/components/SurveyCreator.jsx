...
const SurveyCreator = ({ toggleShowSurveyCreator, getSurveysByUserId }) => {
    ...
    return (
        <form className='container py-2' onSubmit={(e) => sendNewSurvey(e)}>
            <div className={`card ${dark ? 'card--dark survey-card--dark text-light' : 'survey-card--light'} p-4`}>
                ...
                <div className='mt-2'>
                    ...
                    <textarea name="description" id="description" cols="30" rows="5" className={`form-control question__text--dark ${!dark && 'text-light'}`} onChange={(e) => setNewSurvey({ ...newSurvey, description: e.target.value })}></textarea>
                </div>
                <div className="form-check form-switch my-3 d-flex gap-2">
                                ...
                                <>
                                    <div className="col">
                                        ...
                                        <div className="input-group mb-3 d-none d-lg-flex">
                                            <input type="text" className={`form-control ${dark && 'question__text--dark'}`} name='option' onChange={(e) => setOption(e.target.value)} onKeyDown={(e) => addOption(e)} value={option} placeholder="Escribe aquí y presiona enter" aria-label="Recipient's username" aria-describedby="button-addon2" />
