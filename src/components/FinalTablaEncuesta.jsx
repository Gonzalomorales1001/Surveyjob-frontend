...
// import withReactContent from "sweetalert2-react-content"; no es necesario

//import componente de modal para editar
import ModalEdit from "./ModalEdit";

const FinalTablaEncuestas = ({ encuestas = [] }) => {
  // const MySwal = withReactContent(Swal); no es necesario
  ...
  const inactivarEncuesta = async (nombre, id) => {
    Swal.fire({
      title: `Está seguro que quiere inactivar la encuesta ${nombre}?`,
      showDenyButton: true,
              ...
              <td>
                {encuesta.estado ? ( 
                  <svg
                    ...
                    width="16"
                    height="16"
                    fill="currentColor check" //editar con estilos este tamaño usando clas check
