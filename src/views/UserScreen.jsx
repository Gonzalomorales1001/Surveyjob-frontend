          ...
          <>
            <div className="d-flex justify-content-between align-items-center">
              ...
              <button
                ...
                onClick={toggleShowSurveyCreator}
              >
                <i
                  className={`fa ${showSurveyCreator ? "fa-times" : "fa-plus"}`}
                  aria-hidden="true"
                ></i>{" "}
                {showSurveyCreator ? "Cerrar" : "Nueva Encuesta"}
              </button>
            </div>
            <hr />
            {showSurveyCreator && (
              <SurveyCreator
                getSurveysByUserId={getSurveysByUserId}
                toggleShowSurveyCreator={toggleShowSurveyCreator}
              />
            )}
            ...
            {userSurvey ? (
              userSurvey.total != 0 ? (
                ...
                <div className="row justify-content-center align-items-center">
                  ...
                  <div className="col text-center">
                    ...
                    <p>
                      Puedes añadir nuevas encuestas haciendo click en el boton
                      de "Crear nueva encuesta". Además, puedes compartir el
                      enlace para que tus encuestas sean respondidas y
                      <span className="text-warning">
                        {" "}
                        ¡Aquí podras ver los resultados de tus encuestas!{" "}
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div className="row align-items-center justify-content-center py-4 loading-screen">
                <img
                  src={Error500}
                  alt="serverless"
                  className="col-12 col-lg-6 w-50"
                />
